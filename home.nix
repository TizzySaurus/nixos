...

{
  ...
  xdg.configFile."MangoHud/MangoHud.conf".text = ''
    ...
    legacy_layout=false
    pci_dev=0000:01:00.0 # NVIDIA Corporation AD103 GeForce RTX 4080 SUPER rev a1
    width=200
    gpu_stats
    gpu_load_change
    gpu_temp
    ...
    gpu_load_value=80,95
    gpu_load_color=92e79a,ffaa7f,cc0000
    cpu_load_value=80,95
    ...
    media_player_format={title};{artist};{album}g
  '';
